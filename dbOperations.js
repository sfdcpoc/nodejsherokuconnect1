module.exports = {
  getRecords: function(req, res) {    
   ...
   addRecord : function(req, res){
        ...
        var query = client.query("insert into salesforce.Employee__c (name, firstName__c,lastName__c,E_Mail__c) "+ 
                                "values ('" + fullName + "','"+req.query.fName+"','"+req.query.lName+"','"+ req.query.email + "')");
